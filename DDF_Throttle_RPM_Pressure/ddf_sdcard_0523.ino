...
//       duty_fs = 0;
       pwm_start(PB_12, 50, duty_fs, RESOLUTION_11B_COMPARE_FORMAT);
       pwm_start(PB_13, 50, duty_fs, RESOLUTION_11B_COMPARE_FORMAT);
       pwm_start(PB_14, 50, duty_fs, RESOLUTION_11B_COMPARE_FORMAT);
       pwm_start(PB_15, 50, duty_fs, RESOLUTION_11B_COMPARE_FORMAT);
     }
    ...
    attachInterrupt(digitalPinToInterrupt(PB0), interruptPin, FALLING);
  }
}
